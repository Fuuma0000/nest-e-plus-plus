...
async function main() {
  ...
  const workData = [
    {
      work_id: 1,
      name: 'testWorkData1-1',
      catch_copy: 'testCatchCopy1-1',
      description: 'testDescription1-1',
      work_url: 'https://work.example1-1.com',
      movie_url: 'https://movie.example1-1.com',
      system_diagram_url: 'https://system.example1-1.com',
      detail: 'testDetail1-1',
      is_approved: true,
    },
    {
      work_id: 1,
      name: 'testWorkData1-2',
      catch_copy: 'testCatchCopy1-2',
      description: 'testDescription1-2',
      work_url: 'https://work.example1-2.com',
      movie_url: 'https://movie.example1-2.com',
      system_diagram_url: 'https://system.example1-2.com',
      detail: 'testDetail1-2',
      is_approved: true,
    },
    {
      work_id: 1,
      name: 'testWorkData1-3',
      catch_copy: 'testCatchCopy1-3',
      description: 'testDescription1-3',
      work_url: 'https://work.example1-3.com',
      movie_url: 'https://movie.example1-3.com',
      system_diagram_url: 'https://system.example1-3.com',
      detail: 'testDetail1-3',
      is_approved: false,
    },
    {
      work_id: 2,
      name: 'testWorkData2-1',
      catch_copy: 'testCatchCopy2-1',
      description: 'testDescription2-1',
      work_url: 'https://work.example2-1.com',
      movie_url: 'https://movie.example2-1.com',
      system_diagram_url: 'https://system.example2-1.com',
      detail: 'testDetail2-1',
      is_approved: true,
    },
  ];
